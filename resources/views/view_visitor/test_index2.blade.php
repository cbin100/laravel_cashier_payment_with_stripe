...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/favicon.png" href="{{ asset('t_visitor/bizwheel/img/favicon.png') }}">

    <!-- Web Font -->
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">

    <!-- Bizwheel Plugins CSS -->
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/cubeportfolio.min.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/font-awesome.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/jquery.fancybox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/magnific-popup.min.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/owl-carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/slicknav.min.css') }}">

    <!-- Bizwheel Stylesheet -->
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/reset.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/style.css') }}">
    <link rel="stylesheet" href="{{ asset('t_visitor/bizwheel/css/responsive.css') }}">
