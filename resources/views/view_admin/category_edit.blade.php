    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Updating: {{ $post->post_title }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <!-- Main content -->
        <form class="content" method="POST" action="{{ route('category.update', $post->id) }}">
            @csrf
            @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" value="{{ $post->post_title }}"
