                                    ...
                                    @foreach($productcategories as $category)
                                        <tr data-widget="expandable-table" aria-expanded="false">
                                            ...
                                            <td width="11%">
                                                ...
                                                <form class="content" method="POST" action="{{ route('categoryProductDestroy', [$category->id]) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('categoryProductDestroy', $category->id) }}">
                                                        <i class="fas fa-eye text-success  fa-lg" title="Show"></i>
                                                    </a>

                                                    <a href="{{ route('categoryProductEdit', $category->id) }}">
